...
public class PhoneReceiver extends BroadcastReceiver {
    ...
    private PhoneStateListener listener = MainActivity.listener;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_NEW_OUTGOING_CALL)) {
            ...
            if(MainActivity.callInfoVo!=null){
                MainActivity.callInfoVo.setCustomerPhone(outgoingNumber);
            }

            if (!"ACTION_NEW_OUTGOING_CALL".equals(phoneState)) {
                phoneState = "ACTION_NEW_OUTGOING_CALL";
